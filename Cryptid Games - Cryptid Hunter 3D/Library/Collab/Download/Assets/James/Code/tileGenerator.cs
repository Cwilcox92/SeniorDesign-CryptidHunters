...
public class tileGenerator : MonoBehaviour
{
    ...
    void PropogateOil(int x, int y)
    {
        ...
        if(myObject != empty)
        {
            Vector3Int pos1 = new Vector3Int(x +1,-1, y);           
            Vector3Int pos2 = new Vector3Int(x,-1, y +1);
            Vector3Int pos3 = new Vector3Int(x-1,-1,y);
            Vector3Int pos4 = new Vector3Int(x,-1,y-1);
